...
namespace AnarchyChess.Moves
{
    ...
    {
         public readonly List<Pos> TakeList;

        public bool MustTake { get; private set; }

        private readonly Pos _from;
        private readonly Pos _to;
        private Type? _promotesTo;
        private AppliedMove? _followUp;
        ...
        public static AppliedMove Absolute(Pos from, Pos to) => new AppliedMove(from, to);
        ...
        public static AppliedMove Relative(Pos from, Pos offset) => new AppliedMove(from, from + offset);
        ...
        public AppliedMove PromoteTo(Type? piece)
        {
        ...
        public AppliedMove AddFollowUp(AppliedMove appliedMove)
        {
        ...
        public AppliedMove AddTake( params Pos[] to)
        {
        ...
        protected AppliedMove(Pos from, Pos to)
        {
            _from = from;
            _to = to;
