...
namespace AnarchyChess.Scripts.Boards
{
    public static class BoardTemplates
    {
        public static Board Standard()
        {
            ...
            board.AddPiece(new Pos(1, 0), new Knight(Side.White));
            board.AddPiece(new Pos(2, 0), new Bishop(Side.White));
            ...
            board.AddPiece(new Pos(1, 7), new Knight(Side.Black));
            board.AddPiece(new Pos(2, 7), new Bishop(Side.Black));
